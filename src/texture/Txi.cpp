...
const std::vector<TxiDirectiveInfo>& txiDirectiveCatalog() {
    static const std::vector<TxiDirectiveInfo> catalog = {
        ...
        {"defaultwidth", "Basic texture", TxiDirectiveValueKind::SignedShort, "signed 16-bit integer · >0", "2", "Sets the fallback or procedural texture width.", "For cycle animations, frame width is independent of frame height; rectangular frames are supported.", {}},
        {"defaultheight", "Basic texture", TxiDirectiveValueKind::SignedShort, "signed 16-bit integer · >0", "2", "Sets the fallback or procedural texture height.", "For cycle animations, frame height is independent of frame width; rectangular frames are supported.", {}},
