...
const std::vector<TxiDirectiveInfo>& txiDirectiveCatalog() {
    static const std::vector<TxiDirectiveInfo> catalog = {
        ...
        {"defaultwidth", "Basic texture", TxiDirectiveValueKind::SignedShort, "signed 16-bit integer · >0", "2", "Sets the fallback or procedural texture width.", "", {}},
        {"defaultheight", "Basic texture", TxiDirectiveValueKind::SignedShort, "signed 16-bit integer · >0", "2", "Sets the fallback or procedural texture height.", "", {}},
